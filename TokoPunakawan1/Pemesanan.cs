...
namespace TokoPunakawan1
{
    public partial class Pemesanan : Form
    {
        ...
        {
            SqlConnection conn = new SqlConnection("data source = MSI;database=Toko_Punakawan2;User ID=sa;Password=12345678");
        ...
        void insertData()
        {
            ...
            {
                conn.Open();
                SqlCommand insert = new SqlCommand("INSERT INTO Pemesananan (Id_Pemesanan, Id_Kasir, Id_Menu,Nama_Makanan,Jenis_Menu,Harga, Waktu) VALUES" +
                    "('" + Id_Pemesanan.Text + "','" + cb_Kasir.Text + "','" + cb_Menu.Text + "','" + Nama_Makanan.Text + "', '" + Jenis_Menu.Text + "','" + Harga.Text + "','" + dateTimePicker1.Text + "')", conn);
        ...
        void updateData()
        {
            SqlConnection conn = new SqlConnection("data source = MSI;database=Toko_Punakawan2;User ID=sa;Password=12345678");
            conn.Open();
            SqlCommand cmd = new SqlCommand("Update Pemesananan set Id_Pemesanan = @Id_Pemesanan, Id_Kasir = @Id_Kasir, Id_Menu = @Id_Menu, Nama_Makanan = @Nama_Makanan, Jenis_Menu = @Jenis_Menu, Harga = @Harga, Waktu = @Waktu where Id_Pemesanan = @Id_Pemesanan", conn);
            ...
            cmd.Parameters.AddWithValue("@Waktu", dateTimePicker1.Text);
            cmd.ExecuteNonQuery();
        ...
        {
            // TODO: This line of code loads data into the 'toko_Punakawan2DataSet.Pemesananan' table. You can move, or remove it, as needed.
            this.pemesanananTableAdapter.Fill(this.toko_Punakawan2DataSet.Pemesananan);
        ...
        private void cb_Menu_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            SqlConnection conn = new SqlConnection("data source = MSI;database=Toko_Punakawan2;User ID=sa;Password=12345678");
        ...
        private void cb_Kasir_SelectedIndexChanged_1(object sender, EventArgs e)
        {
